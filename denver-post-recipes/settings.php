...
<!--
<tr>
  <td>Home Featured Text:</td>
  <td><input type="text" name="home_featured_text" class="ss_text" value="<?php echo stripslashes(stripslashes(get_option($shortname.'_home_featured_text',''))); ?>" /></td>
</tr>-->
<!--<tr>
  <td>Post Hover Background Color:</td>
